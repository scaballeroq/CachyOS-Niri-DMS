...
# -----------------------------------------------------------------------------
echo "⚙️ [1/10] Optimizando Pacman y Makepkg para Ryzen 7 PRO (16 hilos)..."
...
# -----------------------------------------------------------------------------
echo "🐧 [3/10] Instalando Kernel, Firmware, Microcódigo AMD y configurando Early KMS..."
...
# -----------------------------------------------------------------------------
echo "🎮 [4/10] Instalando controladores gráficos AMD (Mesa RADV, VA-API y utilidades)..."
...
# -----------------------------------------------------------------------------
# 8. Stack Wayland, Portales y Compositor Niri
# -----------------------------------------------------------------------------
