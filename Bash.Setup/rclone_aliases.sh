...
alias gdrive-arch="rclone sync \"/home/caballero/Warehouse/Repositorios/Linux/ArchLinux-Niri-DMS\" \"GoogleDrive:Warehouse/Repositorios/Linux/ArchLinux-Niri-DMS\" $RCLONE_OPTS --log-file \"$RCLONE_LOG_DIR/rclone_repos_arch.log\""
