...
2. **Integración con Niri y Wayland**:
   ...
   - Crea el lanzador de escritorio en `/usr/share/applications/antigravity.desktop` compatible con el lanzador de **Dank Material Shell**.
...
- **Antigravity Desktop**: Ábrelo desde el lanzador de DMS (`Super` / `dms ipc call panel-toggle launcher`) o ejecutando `antigravity &`.
