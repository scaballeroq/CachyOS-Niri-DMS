#!/bin/bash
# post-install.sh - Despachador y selector inteligente de post-instalación para CachyOS (Niri + Dank Material Shell)
...
show_help() {
    cat <<HELPEOF
Despachador de Post-Instalación para CachyOS (Niri & Dank Material Shell)
